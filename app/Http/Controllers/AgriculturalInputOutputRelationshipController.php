...
class AgriculturalInputOutputRelationshipController extends Controller
{
    // GET ALL
    public function index(Request $request)
    {
        $message = "Error al obtener relaciones insumo/producto agrícolas";
        $action = "Listado de relaciones insumo/producto agrícolas";
        $data = null;
        $meta = null;
    ...
    {
        $message = "Error al crear relación insumo/producto agrícola";
        $action = "Crear relación insumo/producto agrícola";
    ...
    {
        $message = "Error al actualizar relación insumo/producto agrícola";
        $action = "Actualizar relación insumo/producto agrícola";
        $id_user = Auth::user()->id ?? null;
        $data = null;

        try {
            $record = AgriculturalInputOutputRelationship::findOrFail($id);
    ...
    {
        $message = "Error al cambiar estado de relación insumo/producto agrícola";
        $action = "Cambiar estado de relación insumo/producto agrícola";
        $id_user = Auth::user()->id ?? null;
        $data = null;
    ...
    {
        $message = "Error al eliminar relación insumo/producto agrícola";
        $action = "Eliminar relación insumo/producto agrícola";
        $id_user = Auth::user()->id ?? null;
