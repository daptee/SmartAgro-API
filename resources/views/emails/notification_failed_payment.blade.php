...
<head>
  ...
  <![endif]-->
  <title>Error en el cobro de un usuario - Plan Siembra MercadoPago</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Error en el cobro de un usuario - Plan Siembra MercadoPago</div>
  <div role="article" aria-roledescription="email" aria-label="Error en el cobro de un usuario" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Esto es una notificación automática indicando que se ha detectado un error en el cobro de un usuario del Plan Siembra.
                      </p>
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        El pago no pudo ser procesado correctamente. Se recomienda hacer seguimiento con el usuario para verificar el estado de su suscripción y método de pago.
                      </p>
