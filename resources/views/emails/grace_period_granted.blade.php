...
<head>
  ...
  <![endif]-->
  <title>Periodo de gracia activado - Plan Siembra SmartAgro</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Periodo de gracia activado - Plan Siembra SmartAgro</div>
  <div role="article" aria-roledescription="email" aria-label="Periodo de gracia activado" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Te informamos que no pudimos procesar el cobro de tu suscripcion al <strong>Plan Siembra</strong> a traves de MercadoPago despues de varios intentos.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Como beneficio por unica vez, hemos activado tu <strong>periodo de gracia</strong>. Esto significa que podras seguir disfrutando de todas las funcionalidades del Plan Siembra durante el proximo mes de manera bonificada, mientras regularizas tu situacion de pago.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>Importante:</strong> Este beneficio se otorga una unica vez. En el proximo ciclo de cobro, si el pago no puede ser procesado, tu cuenta sera migrada automaticamente al Plan Semilla (gratuito).
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>Te recomendamos:</strong><br>
                        - Verificar que tu metodo de pago en MercadoPago este activo y con fondos suficientes.<br>
                        - Asegurarte de que no haya restricciones en tu cuenta de MercadoPago.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px;">
                        <span style="font-weight: 600;">Nota:</span> Si necesitas ayuda o tienes alguna consulta, no dudes en contactarnos a
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Gracias por tu comprension, <br>Equipo de SmartAgro</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="mso-line-height-rule: exactly; padding-left: 48px; padding-right: 48px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; color: #eceff1;">
                      <p align="center" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 16px; cursor: default;">
                        ...
                        &bull;
                        <a href="https://x.com/smartagrook" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img width="20" height="20" src="https://smartagro.io/firmas/x.png" alt="X" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238;">
                        El uso de nuestro servicio y sitio web esta sujeto a nuestros
                        <a href="{{ config('services.url_front') }}/terminos-y-condiciones/" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #16A860; text-decoration: none;">Terminos de uso</a> y
                        <a href="{{ config('services.url_front') }}/politicas-de-privacidad/" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #16A860; text-decoration: none;">Politica de privacidad</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
