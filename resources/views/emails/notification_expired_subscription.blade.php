...
<head>
  ...
  <![endif]-->
  <title>Suscripción vencida de un usuario - Plan Siembra MercadoPago</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Suscripción vencida de un usuario - Plan Siembra MercadoPago</div>
  <div role="article" aria-roledescription="email" aria-label="Suscripción vencida de un usuario" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Esto es una notificación automática indicando que la suscripción de un usuario al Plan Siembra ha vencido después de completar el período de gracia.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 12px;">
                        <strong>Detalles del usuario:</strong>
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 6px;">
                      ...
                      <ul style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px; padding-left: 24px;">
                        <li>El usuario ha sido cambiado al Plan Gratuito (Plan 1)</li>
                        <li>Se le ha enviado una notificación al usuario sobre el vencimiento</li>
                        <li>La suscripción en MercadoPago permanece pausada</li>
                      </ul>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        El usuario puede renovar su suscripción en cualquier momento desde su cuenta.
                      </p>
