...
<head>
  ...
  <![endif]-->
  <title>Servicio regularizado - Plan Siembra SmartAgro</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Servicio regularizado - Plan Siembra SmartAgro</div>
  <div role="article" aria-roledescription="email" aria-label="Servicio regularizado" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Nos alegra informarte que hemos recibido correctamente el cobro de tu suscripcion al <strong>Plan Siembra</strong> a traves de MercadoPago.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Tu servicio ha sido <strong>regularizado exitosamente</strong>. Podras seguir disfrutando de todas las funcionalidades del Plan Siembra con normalidad.
                      </p>
