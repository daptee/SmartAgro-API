...
<head>
  ...
  <![endif]-->
  <title>Error en el cobro - Plan Siembra MercadoPago</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Error en el cobro - Plan Siembra MercadoPago</div>
  <div role="article" aria-roledescription="email" aria-label="Error en el cobro" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Te informamos que hemos detectado un problema al procesar el cobro de tu suscripción al Plan Siembra a través de MercadoPago.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>¿Qué significa esto?</strong><br>
                        El pago no pudo ser procesado exitosamente. Esto puede deberse a diferentes motivos como fondos insuficientes, problemas con tu método de pago, o alguna restricción temporal.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>¿Qué debes hacer?</strong><br>
                        Por favor, revisa tu método de pago en MercadoPago y asegúrate de que esté activo y con fondos suficientes. El sistema intentará procesar el cobro nuevamente en los próximos días.
                      </p>
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Gracias por tu comprensión, <br>Equipo de SmartAgro</p>
                    </td>
                  </tr>
                  <tr>
