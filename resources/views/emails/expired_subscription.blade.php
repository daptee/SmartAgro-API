...
<head>
  ...
  <![endif]-->
  <title>Tu suscripción ha vencido - Plan Siembra MercadoPago</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Tu suscripción ha vencido - Plan Siembra MercadoPago</div>
  <div role="article" aria-roledescription="email" aria-label="Tu suscripción ha vencido" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        Lamentamos informarte que tu suscripción al <strong>Plan Siembra</strong> ha vencido debido a que no se pudo procesar el pago durante el período de gracia.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>¿Qué significa esto?</strong><br>
                        Tu cuenta ha sido cambiada al Plan Gratuito. Ya no tendrás acceso a las funcionalidades premium del Plan Siembra.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <strong>¿Quieres recuperar tu Plan Siembra?</strong><br>
                        Puedes volver a suscribirte en cualquier momento desde tu cuenta. Asegúrate de que tu método de pago en MercadoPago esté actualizado y tenga fondos suficientes.
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                        <a href="{{ config('services.url_front') }}/suscripcion" style="display: inline-block; background-color: #16A860; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: 600;">Renovar Suscripción</a>
                      </p>
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px;">
                        <span style="font-weight: 600;">Nota:</span> Si tienes alguna pregunta o necesitas ayuda, contáctanos a
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Gracias por haber sido parte de nuestro Plan Siembra, <br>Equipo de SmartAgro</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="mso-line-height-rule: exactly; padding-left: 48px; padding-right: 48px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; color: #eceff1;">
                      <p align="center" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 16px; cursor: default;">
                        ...
                        &bull;
                        <a href="https://www.instagram.com/smartagrook" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img width="20" height="20" src="https://smartagro.io/firmas/instagram.png" alt="Linkedin" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                        &bull;
                        <a href="https://www.tiktok.com/@smartagrook" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img width="20" height="20" src="https://smartagro.io/firmas/tiktok.png" alt="Linkedin" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                        &bull;
                        <a href="https://x.com/smartagrook" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img width="20" height="20" src="https://smartagro.io/firmas/x.png" alt="Linkedin" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                      </p>
